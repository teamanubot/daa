...
class PayMethodPolicy
{
    ...
    {
        return $user->can('view_any_pay::method');
    }
    ...
    {
        return $user->can('view_pay::method');
    }
    ...
    {
        return $user->can('create_pay::method');
    }
    ...
    {
        return $user->can('update_pay::method');
    }
    ...
    {
        return $user->can('delete_pay::method');
    }
    ...
    {
        return $user->can('delete_any_pay::method');
    }
     ...
     */
    public function replicate(User $user, PayMethod $payMethod): bool
    {
